    ...
    , keytime(0.f)
{
    ...
    this->activeElement = new gui::Button(
        sf::Vector2f(x, y), sf::Vector2f(width, height), this->font, list[default_index], char_size,
    ...
    for (unsigned i = 0; i < nrOfElements; i++)
        this->list.push_back(new gui::Button(
            sf::Vector2f(x, y + ((i + 1) * height)), sf::Vector2f(width, height), this->font, list[i], char_size,
