...
const bool GraphicsSettings::saveToFile(const std::string path) {
	...
	//save to json file
	ofs << "{\n";
	ofs << "\t\"title\"" << ": " << "\"" << this->title << "\"" << ",\n";
	ofs << "\t\"resolution\": " << "{\n";
	ofs << "\t\t\"width\": " << "\"" << this->resolution.width << "\"" << ",\n";
	ofs << "\t\t\"height\": " << "\"" << this->resolution.height << "\"" << "\n";
	ofs << "\t},\n";
	ofs << "\t\"fullscreen\"" << ": " << "\"" << this->fullscreen << "\"" << ",\n";
	ofs << "\t\"frameRateLimit\"" << ": " << "\"" << this->frameRateLimit << "\"" << ",\n";
	ofs << "\t\"verticalSync\"" << ": " << "\"" << this->verticalSync << "\"" << ",\n";
	ofs << "\t\"antialiasingLevel\"" << ": " << "\"" << this->contextSettings.antialiasingLevel << "\"" << ",\n";
	ofs << "\t\"gridSize\"" << ": " << "\"" << this->gridSize << "\"" << "\n";
	ofs << "}";
	//close json file
	ofs.close();
	return true;
